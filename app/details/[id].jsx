    ...
    <>
      <ScrollView className="flex h-full">
        ...
        <View className="px-2 mt-4 pb-8 relative">
          ...
          >
            <View className="flex flex-row justify-between border-2 border-gray-700/20  py-3 px-4 rounded-xl">
              <View className="space-y-2">
                <Text className="font-medium">Price</Text>
                <Text className="text-lg font-bold text-black">{`₹ ${tour?.cost}`}</Text>
              </View>
              <View className="space-y-2">
                <Text className="font-medium">Seats Available</Text>
                <Text className="text-lg font-bold text-black text-right">
                  {`${tour?.seats} seats`}
                </Text>
              </View>
            </View>
          </LinearGradient>
          <View className="flex flex-row justify-between py-3 px-4 rounded-xl mt-4">
            <View className="space-y-2">
              <Text className="font-medium">Tour Name</Text>
              <Text className="text-lg font-bold text-black">{`${tour?.name}`}</Text>
            </View>
            <View className="space-y-2">
          ...
          <View className="px-4 space-y-2 mt-3">
            ...
            <Text className="text-justify tracking-wider text-md font-semibold">
      ...
      <Modalize
        ...
        className="h-full"
      >
        <View className="flex justify-center items-center h-[295px]">
          ...
          <Text className="text-lg mt-2">Our team will reach out to you.</Text>
        </View>
        <Button
          title="Close"
          color={"red"}
        ...
        <View className="h-full relative">
          <View className={`flex px-4 h-[600px]`}>
            ...
            >
                ...
                <View className="mt-8 space-y-4">
                  ...
                  <View className="flex flex-row justify-end items-center px-1">
                    <Button onPress={handleCancel}>
                      <View className="bg-red-700 w-[80px] flex justify-center items-center py-1.5 rounded-md mr-2">
                        <Text className="font-semibold text-white">Cancel</Text>
                      </View>
                    </Button>
                    <Button onPress={handleSaveMember}>
                      <View className="bg-green-700 w-[80px] flex justify-center items-center py-1.5 rounded-md">
              ...
              {!showAddMember && (
                <View className="bg-green-700 w-40 mt-4 py-2 px-2 rounded-md">
          ...
          <View className="px-4 absolute bottom-0 pb-8 pt-1 bg-white">
